...
<table>
    ...
    <tbody>
        ...
        <tr>
            <td style="text-align: center;"><a href="/javascript/docs/0802.html">프로토타입 체인</a></td>
            <td style="text-align: left;"><a href="/javascript/0802/">JavaScript에 내장된 Array 객체의 하위 클래스로 List 객체 생성하기</a><br>- List 객체는 Array 객체의 속성 및 메서드를 그대로 사용할 수 있으며, 추가 속성/메서드로 설명(<code>description</code>), 첫 항목의 자료형(<code>getFirstDataType()</code>), 모든 (숫자) 항목 더하기(<code>sum()</code>)을 포함해야 함<br>- <code>new List(description)</code>의 형태로 <code>description</code>을 입력받아야 함</td>
        </tr>
        <tr>
        ...
        <tr>
            <td style="text-align: center;"><a href="/javascript/docs/0814.html">오류 객체 1</a></td>
            <td style="text-align: left;"><a href="/javascript/0814/">각 오류가 발생하는 코드와 해결(디버깅) 방법</a></td>
        </tr>
        <tr>
        ...
        <tr>
            <td style="text-align: center;"><a href="/javascript/docs/0731.html">Promise</a></td>
        ...
        <tr>
            ...
            <td style="text-align: center;"><a href="/javascript/docs/0804.html">웹 서버 기초</a></td>
            <td style="text-align: left;"><a href="/javascript/0804/">입력한 URL에 따라 다른 값을 반환하는 웹 서버 만들기</a><br>- switch문 사용</td>
        </tr>
        <tr>
        ...
        <tr>
            <td style="text-align: center;" rowspan="5">기타</td>
        ...
        <tr>
            <td style="text-align: center;" colspan="2"><a href="/javascript/docs/0821.html">코드의 재구성</a></td>
        </tr>
    </tbody>
</table>
